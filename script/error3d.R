...
simTableOriginal <- read.table(in_original, col.names = c("xpos", "ypos", "zpos", "density", "velx", "vely", "velz"))
simTableAcr <- read.table(in_acr, col.names = c("xpos", "ypos", "zpos", "density", "velx", "vely", "velz"))

if (!all.equal(simTableOriginal[,c("xpos", "ypos", "zpos")],simTableAcr[,c("xpos", "ypos", "zpos")])) {
